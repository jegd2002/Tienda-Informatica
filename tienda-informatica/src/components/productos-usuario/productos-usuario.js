        ...
        <section class="py-1 text-center container">
          <div class="row py-lg-2">
            <div class="col-lg-7 col-md-8 mx-auto">
              <h1 class="fw-light">
                Bienvenido a nuestra tienda de electronica
              </h1>
              <p class="lead text-muted">
                Para nosotros es un placer tenerte aqui, espero sea de tu agrado
                y podamos tener pronto nuevamente
              </p>
              <p>
                ...
                <br></br>
                <a href="http://localhost:3000/" class="btn btn-secondary my-2">
                  Volver al Inicio
                </a>
              </p>
            </div>
